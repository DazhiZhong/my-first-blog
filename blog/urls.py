...
from .views import blog_detail_view,blog_outline_view,user_login_view,blog_pay_view,blog_cart_view,del_cart_view,pay_cart_view,blog_make_view
app_name = 'Blog'
urlpatterns = [
    ...
    path('do/',blog_make_view,name="blog_make")
